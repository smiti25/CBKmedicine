			...
			<section class="breadcrumbs">
				...
				<div class="container">
					...
					<ul class="horizontal_list clearfix bc_list f_size_medium">
						...
						<li><a href="#" class="default_t_color">Thank You</a></li>
				...
				<div class="container">
					...
					<div class="row clearfix">
					   ...
					   <div class="alert_box r_corners color_green success m_bottom_10">
							...
							<i class="fa fa-smile-o"></i><p>Thanks a lot for your order. Your order id is <?php echo $_GET['order_id'];?>. <?php echo $_GET['msg'];?></p>
