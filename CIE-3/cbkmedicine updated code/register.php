...
function validateEmail(email)
{
    ...
    //alert(dotpos);
    var atpos  = email.indexOf("gmail");   // The indexOf() method returns the position of the first occurrence of a specified value in a string. // Default value of start is 0  
    //alert(atpos);
