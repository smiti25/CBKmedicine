						...
						<section class="col-lg-12 col-md-12 col-sm-12" style="min-height: 380px;">
							...
							<div class="row clearfix">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30">
                                    ...
                                    <a class="tr_delay_hover r_corners button_type_14 bg_color_blue color_light pull-right m_right_5" href="addproduct.php">Add Product</a>
